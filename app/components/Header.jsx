    ...
    return (
        <div className='w-11/12 max-w-3xl mx-auto flex flex-col items-center justify-center text-center h-screen'>
            ...
            <motion.h3
                ...
                className='flex items-end gap-2 text-xl md:text-2xl mb-3 font-Ovo'>Hi am Sunjo William  <Image src={assets.hand_icon} alt='' className='
             w-6'/></motion.h3>
            <motion.h1
                ...
                Front end web developer base in London</motion.h1>
            <motion.p
                initial={{ opacity: 0 }}
                whileInView={{ opacity: 1 }}
                transition={{ duration: 0.6, delay: 0.7 }}
                className='max-w-2xl mx-auto font-Ovo'>I am a front end developer from California, USA with 10 years of experience with multiple companies like
            ...
            <div className='flex flex-col sm:flex-row gap-4 mt-4 items-center'>
                <motion.a
                    ...
                    gap-2 bg-black text-white dark:bg-transparent'>
